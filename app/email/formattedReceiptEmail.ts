...
export const formattedReceiptEmail = () => {
    return `
  <!DOCTYPE html>
...
<style>
		* {
		...
		@media (max-width:520px) {
			...
			.row-1 .column-1 .block-2.image_block img,
			...
			.row-1 .column-1 .block-2.image_block .alignment {
...
<div align="left" class="alignment" style="line-height:10px"><img src="${ logoIcon }" style="display: block; height: auto; border: 0; width: 70px; max-width: 100%;" width="70"/></div>
</td>
</tr>
</table>
</td>
...
<h1 style="margin: 0; color: #555555; font-size: 30px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Thank you for your message!</span></h1>
</td>
</tr>
</table>
</td>
...
<tr>
<td class="pad">
<div style="color:#000000;font-size:22px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:26.4px;">
<p style="margin: 0;">I will be in touch with you soon regarding your message. I look forward to working with you to create a product that is custom-tailored to your specifications and needs!</p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<div style="color:#000000;font-size:19px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:right;direction:ltr;letter-spacing:0px;mso-line-height-alt:22.8px;">
<p style="margin: 0;">- Alex Johnson</p>
</div>
</td>
</tr>
</table>
...
<tr>
<td style="padding:0 2px 0 2px;"><a href="https://www.linkedin.com/in/johnsonav/" target="_blank"><img alt="LinkedIn" height="32" src="/linkedin2x.png" style="display: block; height: auto; border: 0;" title="LinkedIn" width="32"/></a></td>
<td style="padding:0 2px 0 2px;"><a href="https://github.com/johnsonav1992" target="_blank"><img alt="GitHub" height="32" src="/github-mark.png" style="display: block; height: auto; border: 0;" title="GitHub" width="32"/></a></td>
</tr>
</table>
</div>
</td>
